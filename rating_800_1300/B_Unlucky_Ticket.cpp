...
class Solution{
     public:
       void sol(){
            ...
            // string firstHalf = st.substr(0,n);
            // string secondHalf = st.substr(n);

            //Now compare if less, then its count equal to n,
            //if greater then its count equals n
            ...
            for(int i=0;i<n;i++){
                ...
                for(int j=n;j<2*n;j++){
                    ...
                    if(greater >= 1 && less >= 1) {
                        cout << first << " " <<sec << " "<<greater << " "<<less <<endl;
                        break;
                    }
